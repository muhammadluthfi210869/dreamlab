...
export default function BrandShowcaseSection({ content }: BrandShowcaseSectionProps) {
  return (
          ...
          >
            <div className="space-y-2">
              <span className="text-[11px] font-black tracking-[0.25em] text-brand-orange uppercase">
                {content?.eyebrow || "Dreamlab #JUARA FORMULA"}
              </span>
              <h2 className="text-3xl md:text-5xl font-black text-brand-black tracking-tight leading-[1.1] uppercase">
                {content?.title || <>Wujudkan Brand <span className="text-brand-orange text-glow">Bersama Dreamlab</span></>}
              </h2>
            </div>
            ...
            <p className="text-sm md:text-base text-gray-600 leading-relaxed font-medium">
              {content?.description || <>Dreamlab adalah perusahaan maklon kosmetik dengan layanan lengkap dari awal hingga akhir. Kami menawarkan <strong className="text-brand-black">One Stop Maklon Service</strong>, mulai dari konsultasi, pembuatan formula, desain kemasan, produksi, hingga pengurusan izin BPOM dan Halal.</>}
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              ...
              >
                ...
                {content?.primaryCta || "KONSULTASI GRATIS (WA)"}
              </Link>
              ...
              >
                {content?.secondaryCta || "PELAJARI ALUR MAKLON"}
