...
export function TrackingScripts() {
  return (
    <>
      ...
      {/* GA4 + Google Ads Linker (via gtag) */}
      <Script id="ga4-script" strategy="afterInteractive" src={`https://www.googletagmanager.com/gtag/js?id=${GA4_ID}`} />
...
export { GTM_ID, GA4_ID, META_PIXEL_ID, TIKTOK_PIXEL_ID };
