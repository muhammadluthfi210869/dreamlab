...
export default function FaqHome() {
  ...
  const faqItems = [
    ...
    {
      question: "Berapa batas Minimum Order Quantity (MOQ) di Dreamlab?",
      answer: "Kami mendukung akselerasi brand baru dengan menawarkan MOQ yang sangat fleksibel dan bersahabat. Batas minimum pemesanan disesuaikan secara dinamis dengan kategori produk dan spesifikasi bahan aktif yang digunakan. Hal ini memungkinkan Anda menguji pasar tanpa risiko inventaris berlebih atau tekanan modal awal yang terlampau besar."
    },
    {
      question: "Apakah seluruh perizinan BPOM, Halal, dan HAKI diurus oleh Dreamlab?",
      answer: "Ya, sepenuhnya. Tim compliance dan legalitas Dreamlab mengawal seluruh proses birokrasi dari awal hingga tuntas—termasuk sertifikasi Halal MUI, pendaftaran HAKI (merek dagang), hingga penerbitan Nomor Notifikasi BPOM resmi. Anda hanya perlu fokus pada strategi penjualan, sementara aspek legalitas produk kami selesaikan secara bersih dan transparan."
    },
    {
      question: "Bagaimana proses pembuatan sampel formula dan biayanya?",
      answer: "Proses awal konsultasi konsep produk dan pembuatan sampel pertama di laboratorium R&D kami adalah 100% Gratis. Jika sampel memerlukan penyesuaian sensorik (tekstur, aroma, efikasi), kami memberikan fasilitas revisi formula hingga produk benar-benar memenuhi standar kelayakan dan kepuasan mutlak Anda sebelum masuk ke lini produksi massal."
    },
    {
      question: "Dukungan apa saja yang saya dapatkan setelah proses produksi selesai?",
      answer: "Kemitraan kami bersifat jangka panjang. Setelah proses produksi selesai, Dreamlab memberikan Go-To-Market Support eksklusif berupa penyediaan aset promosi digital, paket foto produk studio profesional, katalog teknis siap pakai, hingga sesi konsultasi strategi pemasaran online dan offline untuk memastikan peluncuran brand Anda sukses besar."
    }
  ];
