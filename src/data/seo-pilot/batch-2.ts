...
export const pabrikParfumMoneyPage: PilotPageData = {
  ...
  relatedLinks: [
    ...
    },
    {
      ...
      description: 'Solusi private label cepat dengan formula siap pakai dan BPOM.',
      intent: 'secondary',
    },
    {
...
export const jasaMaklonKosmetikMoneyPage: PilotPageData = {
  ...
  relatedLinks: [
    ...
    },
    {
      label: 'Estimasi Biaya Maklon',
      href: '/estimasi-biaya-maklon-kosmetik',
      description: 'Cek estimasi biaya produksi kosmetik untuk brand Anda.',
      intent: 'secondary',
    },
  ],
  leadForm: {
...
export const privateLabelKosmetikMoneyPage: PilotPageData = {
  ...
  relatedLinks: [
    ...
    },
    {
      label: 'Estimasi Biaya Maklon',
      href: '/estimasi-biaya-maklon-kosmetik',
      description: 'Cek estimasi biaya produksi sesuai budget brand Anda.',
      intent: 'secondary',
    },
  ],
  leadForm: {
...
export const estimasiBiayaMaklonMoneyPage: PilotPageData = {
  ...
  relatedLinks: [
    ...
    },
    {
      label: 'Jasa Maklon Kosmetik',
      href: '/jasa-maklon-kosmetik',
      description: 'Layanan maklon kosmetik lengkap untuk skincare hingga parfum.',
      intent: 'secondary',
    },
    {
      label: 'Private Label Kosmetik',
      href: '/private-label-kosmetik',
      description: 'Solusi private label cepat untuk memiliki brand sendiri.',
      intent: 'secondary',
    },
  ],
  leadForm: {
