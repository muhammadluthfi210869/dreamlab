  ...
  products: [
    {
      ...
      shortDescription: "Maklon Eau de Parfum (EDP) dengan konsentrasi fragrance oil 15-20%. Memberikan jejak aroma (sillage) yang elegan dan bertahan hingga 12 jam.",
...
Eau de Parfum (EDP) adalah standar emas bagi brand yang ingin menonjolkan kualitas dan eksklusivitas. Di Dreamlab, kami memformulasikan EDP dengan teknik fiksasi canggih yang memastikan aroma berkembang secara sempurna dari top, heart, hingga base notes. Produk ini dirancang khusus untuk memberikan performa maksimal di tengah kelembapan iklim tropis Indonesia.`,
      ...
      bottleOptions: ["Spray Bottle", "Glass Bottle", "Custom Exclusive Packaging"],
      capOptions: ["Aluminum Silver", "Aluminum Gold", "Wooden Cap", "Premium Metal"],
      moq: "1000 pcs",
    ...
    },
    {
      ...
      shortDescription: "Maklon Eau de Toilette (EDT) untuk pemakaian harian yang segar dan ringan. Konsentrasi 8-15% yang ideal untuk aktivitas semi-formal dan kantor.",
...
Eau de Toilette (EDT) dirancang untuk memberikan impresi yang bersih dan menyegarkan. Di Dreamlab, kami mengkurasi formula EDT yang memiliki karakteristik "airy" dan "uplifting". Sangat cocok bagi brand yang menyasar pasar profesional muda yang aktif, di mana wewangian menjadi bagian dari rutinitas harian yang meningkatkan kepercayaan diri.`,
      ...
      sizeOptions: ["30ml", "50ml", "100ml"],
      bottleOptions: ["Spray Bottle", "Glass Bottle", "Custom Exclusive Packaging"],
      capOptions: ["Flip Top", "Spray Cap", "Sport Cap"],
      moq: "1000 pcs",
      productionTime: "2-3 bulan",
      certifications: ["BPOM", "Halal MUI", "CPKB Grade A"],
    },
    {
      ...
      shortDescription: "Maklon Eau de Cologne (EDC) dengan aroma ringan yang sangat menyegarkan. Konsentrasi 3-8% yang sempurna untuk pasar masal dan koleksi sport.",
...
Eau de Cologne (EDC) adalah pilihan populer bagi konsumen yang mencari wewangian ringan pasca mandi atau setelah berolahraga. Di Dreamlab, kami menciptakan EDC dengan basis citrus dan herba yang memberikan efek "cooling" seketika. Ini adalah produk entry-level yang sangat efektif untuk membangun basis konsumen setia bagi brand baru Anda.`,
      ...
      bottleOptions: ["Spray Bottle", "Glass Bottle", "Custom Exclusive Packaging"],
      capOptions: ["Standard Spray", "Atomizer", "Cork"],
      moq: "1000 pcs",
      productionTime: "2-3 bulan",
      certifications: ["BPOM", "Halal MUI", "CPKB Grade A"],
    },
    {
      ...
      shortDescription: "Maklon Extrait de Parfum — kasta tertinggi dalam dunia wewangian. Konsentrasi 20-40% fragrance oil untuk ketahanan aroma hingga 24 jam.",
...
Extrait de Parfum bukan sekadar parfum, melainkan pernyataan kemewahan. Dengan konsentrasi fragrance oil tertinggi, setiap semprotan memberikan kedalaman aroma yang luar biasa dan daya tahan yang melampaui ekspektasi. Di Dreamlab, kami mengolah Extrait dengan bahan baku grade tertinggi untuk menciptakan mahakarya yang akan menjadi kebanggaan setiap kolektor.`,
      ...
      sizeOptions: ["30ml", "50ml", "100ml"],
      bottleOptions: ["Crystal Square", "Artisan Round", "Limited Edition"],
      capOptions: ["Gold Plated", "Crystal", "Handcrafted Wood"],
      moq: "500 pcs",
      productionTime: "3-4 bulan",
      certifications: ["BPOM", "Halal MUI", "CPKB Grade A"],
    },
    {
      id: "body-mist",
      ...
      shortDescription: "Maklon Body Mist untuk gaya hidup aktif dan dinamis. Formula ringan 1-3% yang dapat digunakan berkali-kali sepanjang hari dengan harga terjangkau.",
...
Body Mist adalah produk yang paling cepat berputar di pasar karena kepraktisannya. Di Dreamlab, kami memastikan Body Mist brand Anda memiliki kualitas yang melampaui produk masal lainnya. Kami memformulasikan mist yang tidak hanya harum, tetapi juga lembut di kulit, menjadikannya pilihan sempurna untuk melengkapi koleksi lifestyle brand Anda.`,
      ...
      bottleOptions: ["Spray Bottle", "Frosted Bottle", "Custom Exclusive Packaging"],
      capOptions: ["Fine Mist Spray", "Trigger Spray", "Flip Cap"],
      moq: "3000 pcs",
    ...
    },
    {
      ...
      shortDescription: "Maklon Minyak Atsiri murni untuk segmen kesehatan dan wellness. Bahan baku natural berkualitas farmasi dengan metode ekstraksi terbaik.",
...
Minyak atsiri (Essential Oil) adalah jiwa dari industri aromaterapi. Dreamlab menyediakan akses ke bahan-bahan atsiri terbaik dari seluruh nusantara dan mancanegara. Kami memastikan setiap tetes minyak atsiri yang kami produksi memiliki profil kimia yang stabil dan kemurnian yang terjamin, memberikan nilai tambah bagi brand wellness Anda.`,
    ...
    },
    {
      ...
      name: "Reed Diffuser",
      slug: "reed-diffuser",
      heroImage: "/assets/images/edt-scaled.webp",
      galleryImages: ["/assets/images/edt-scaled.webp"],
      tags: ["Home Fragrance", "Ambient", "Long Lasting"],
      shortDescription: "Maklon Reed Diffuser untuk pewangi ruangan yang elegan dan tahan lama. Kampas buluh menyerap dan menyebarkan aroma secara konsisten.",
      story: `Reed diffuser adalah solusi pewangi ruangan yang tidak memerlukan listrik atau api — murni elegan dan fungsional.

Di Dreamlab, kami merancang reed diffuser dengan perbandingan fragrance oil yang optimal agar aroma menyebar merata dan konsisten selama 2-3 bulan. Campuran essential oil dan fragrance oil pilihan kami memastikan aroma yang halus namun hadir di ruangan, menciptakan suasana yang menyenangkan tanpa intervensi manual.`,
      seoParagraph: "Maklon Reed Diffuser — jasa maklon pewangi ruangan elegan dengan kampas buluh dan botol kaca premium. Ketahanan aroma hingga 2-3 bulan. ✓ BPOM & Halal ✓ MOQ 1000 pcs.",
      benefits: [
        "Ketahanan 2-3 Bulan — aroma konsisten tanpa perlu pengawasan",
        "Tanpa Api & Listrik — aman untuk ruangan tertutup dan area anak",
        "Estetika Premium — botol kaca dan kampas buluh yang menambah keindahan ruangan",
        "Custom Fragrance — lebih dari 200 pilihan aroma untuk identitas brand",
        "Varian Aroma: Floral, Woody, Citrus, Fresh, Oriental",
        "Sertifikasi BPOM & Halal",
      ],
      ingredients: [
        { name: "Fragrance Oil Blend", origin: "Grasse, France", function: "Basis aroma premium yang tahan lama" },
        { name: "Dipropylene Glycol", origin: "Germany", function: "Solvent yang memperlambat penguapan" },
        { name: "Essential Oil Blend", origin: "Indonesia", function: "Aroma alami yang menambah kedalaman" },
      ],
      sizeOptions: ["100ml", "200ml", "300ml", "500ml"],
      bottleOptions: ["Glass Bottle", "Reed Stick Bottle"],
      capOptions: ["Cork", "Cap Plug"],
      moq: "1000 pcs",
      productionTime: "2-3 bulan",
      certifications: ["BPOM", "Halal MUI", "CPKB Grade A"],
    },
    {
      ...
      name: "Parfum",
      slug: "parfum",
      heroImage: "/assets/images/edp-scaled.webp",
      galleryImages: ["/assets/images/edp-scaled.webp"],
      tags: ["Pure", "Luxury", "Concentrated"],
      shortDescription: "Maklon Parfum murni dengan konsentrasi tinggi untuk aroma yang dalam dan personal. Tersedia dalam format spray dan roller ball.",
      story: `Parfum adalah ungkapan identitas paling personal yang bisa dikenakan seseorang.

Di Dreamlab, kami meracik parfum murni dengan bahan baku grade tertinggi untuk memastikan setiap sentuhan aroma memberikan kesan mendalam. Tersedia dalam format spray untuk kemudahan dan roller ball untuk presisi aplikasi — dua cara menikmati aroma signature yang sama. Konsentrasi fragrance oil yang tinggi memastikan daya tahan dan projeksi aroma yang luar biasa.`,
      seoParagraph: "Maklon Parfum murni — jasa produksi parfum konsentrat dengan format spray dan roller ball. Ketahanan 12-24 jam dengan sillage kuat. ✓ BPOM & Halal ✓ MOQ 1000 pcs.",
      benefits: [
        "Konsentrasi Tinggi — aroma yang dalam dan personal",
        "Ketahanan 12-24 Jam — sillage kuat yang bertahan sepanjang hari",
        "Dual Format — spray untuk kemudahan, roller ball untuk presisi",
        "Bahan Baku Premium — dari supplier Grasse, Prancis",
        "Custom Fragrance — lebih dari 300 pilihan aroma eksklusif",
        "Sertifikasi BPOM & Halal",
      ],
      ingredients: [
        { name: "Premium Fragrance Oil", origin: "Grasse, France", function: "Basis aroma konsentrat berkualitas tinggi" },
        { name: "Alcohol Denat", origin: "Germany", function: "Carrier yang memaksimalkan proyeksi aroma" },
        { name: "Fixative Blend", origin: "Switzerland", function: "Mengunci aroma agar bertahan lebih lama" },
      ],
      notesPyramid: {
        top: ["Bergamot", "Pink Pepper", "Saffron"],
        heart: ["Rose Absolute", "Jasmine Sambac", "Oud"],
        base: ["Amber", "Musk", "Sandalwood"],
      },
      sizeOptions: ["10ml", "15ml", "30ml", "50ml"],
      bottleOptions: ["Spray Bottle", "Roller Bottle"],
      capOptions: ["Spray Cap", "Roller Ball Cap"],
      moq: "1000 pcs",
      productionTime: "2-3 bulan",
      certifications: ["BPOM", "Halal MUI", "CPKB Grade A"],
    },
