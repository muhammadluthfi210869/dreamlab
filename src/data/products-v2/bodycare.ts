...
export const bodycareData: ProductCategoryV2 = {
  ...
  comparisonOptions: ["Body Lotion", "Body Wash", "Body Scrub", "Body Butter", "Massage Oil", "Body Oil", "Anti-Bacterial Soap", "Shower Gel", "Bath Salt", "Organic Soap", "Body Serum", "Transparent Soap", "Underarm Cream", "Whitening Soap", "Bar Soap", "Massage Cream", "Soothing Gel", "Neck Cream", "Deodorant"],
  comparisonMatrix: {
    "Body Lotion": {
    ...
    "Deodorant": {
      konsentrasi: "Spray / Roll-on / Serum",
      haltbarkeit: "Perlindungan 12-24 Jam",
      marktposition: "Daily Care - Premium",
      moq: "1000 pcs",
      preisklasse: "Mid-Range - Premium",
      karakter: "Anti-bau, cepat kering, segar",
      bestFor: ["Daily Use", "Sensitive Skin", "Active Lifestyle"],
      ingredients: ["Natural Deo Actives", "Niacinamide", "Aloe Vera"],
    },
  },
  products: [
    {
...
Underarm Cream Dreamlab diformulasikan khusus untuk mengatasi masalah umum area ketiak: hiperpigmentasi, bau badan, dan kulit kasar. Dengan kombinasi Niacinamide untuk mencerahkan, antiperspiran alami untuk mengontrol keringat, dan emolien yang menghaluskan tekstur kulit. Hasilnya: ketiak yang cerah, halus, dan segar sepanjang hari.`,
    ...
    },
    {
      ...
      tags: ["Deodorant", "Anti-Bau", "Body Care"],
      shortDescription: "Maklon Deodorant BPOM & Halal — pilih varian spray, roll on, atau dry serum. Formula eksklusif 1 klien 1 formula, konsultasi gratis Dreamlab.",
      story: `Dreamlab menyediakan layanan maklon deodorant dengan 3 varian pilihan: Deodorant Spray untuk daily use yang cepat kering, Deodorant Roll On dengan tekstur lembut untuk kulit sensitif, dan Deodorant Dry Serum format serum ringan ala tren Korea. Semua varian diformulasikan dengan bahan aktif anti-bau pilihan dan fragrance premium — 1 klien, 1 formula.`,
      seoParagraph: "Jasa maklon deodorant BPOM & Halal — pilih varian spray, roll on, atau dry serum. Formula eksklusif 1 klien 1 formula, konsultasi gratis Dreamlab.",
      benefits: [
        "3 Varian Pilihan: Spray, Roll On, dan Dry Serum",
        "FREE Custom Formula — Anda menentukan bahan aktif dan aroma sesuai varian",
        "FREE Pengurusan Legalitas — BPOM, HKI, dan Halal",
        "1 Client, 1 Formula — formula eksklusif milik brand Anda",
        "Bahan Aktif Premium: Natural Deo Actives, Niacinamide, Hyaluronic Acid",
        "Sertifikasi BPOM & Halal",
      ],
      ingredients: [
        { name: "Natural Deo Actives", origin: "Germany", function: "Bahan aktif anti-bau alami" },
        { name: "Niacinamide", origin: "Korea", function: "Mencerahkan dan merawat area ketiak" },
        { name: "Aloe Vera Extract", origin: "Local", function: "Menenangkan dan melembapkan" },
      ],
      sizeOptions: ["30ml", "50ml", "75ml", "100ml", "150ml"],
      bottleOptions: ["Spray Bottle", "Roll On Bottle", "Dropper Bottle", "Custom"],
      capOptions: ["Spray Cap", "Roller Ball", "Rubber Dropper", "Screw Cap"],
      moq: "1000 pcs",
      productionTime: "2-3 bulan",
      certifications: ["BPOM", "Halal MUI", "CPKB Grade A"],
    },
...
Neck Cream Dreamlab diformulasikan khusus untuk kulit leher yang lebih tipis dan rentan terhadap garis halus serta kekenduran. Dengan Peptide Complex untuk merangsang produksi kolagen, Hyaluronic Acid untuk hidrasi mendalam, dan bahan pengencang alami. Penggunaan rutin membantu mengencangkan kulit leher, menyamarkan garis halus, dan menjaga elastisitas untuk tampilan yang lebih muda.`,
  ...
  relatedProducts: [
    ...
    { name: "Deodorant", slug: "deodorant", image: "/new asset/bodycare/deodorant-spray.webp", category: "Body Care", categorySlug: "bodycare" },
  ],
};