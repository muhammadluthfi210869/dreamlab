...
export const bodycareData: ProductCategoryV2 = {
  ...
  comparisonOptions: ["Body Lotion", "Body Wash", "Body Scrub", "Body Butter", "Massage Oil", "Body Oil", "Anti-Bacterial Soap", "Shower Gel", "Bath Salt", "Organic Soap", "Body Serum", "Transparent Soap", "Underarm Cream", "Whitening Soap", "Bar Soap", "Massage Cream", "Soothing Gel", "Neck Cream", "Deodorant Spray", "Deodorant Roll On", "Deodorant Dry Serum", "Deodorant Balm"],
  comparisonMatrix: {
    "Body Lotion": {
    ...
    "Deodorant Balm": {
      konsentrasi: "Solid balm stick",
      haltbarkeit: "Perlindungan 24 Jam",
      marktposition: "Premium",
      moq: "1000 pcs",
      preisklasse: "Mid-Range - Premium",
      karakter: "Padat, praktis, anti-bau",
      bestFor: ["On-The-Go", "Travel", "Sport"],
      ingredients: ["Natural Deo Actives", "Shea Butter", "Vitamin E"],
    },
  },
  products: [
    {
...
Underarm Cream Dreamlab diformulasikan khusus untuk mengatasi masalah umum area ketiak: hiperpigmentasi, bau badan, dan kulit kasar. Dengan kombinasi Niacinamide untuk mencerahkan, antiperspiran alami untuk mengontrol keringat, dan emolien yang menghaluskan tekstur kulit. Hasilnya: ketiak yang cerah, halus, dan segar sepanjang hari.`,
    ...
    },
    {
      ...
      name: "Deodorant Balm",
      slug: "deodorant-balm",
      heroImage: "/new asset/bodycare/deodorant-balm.webp",
      galleryImages: ["/new asset/bodycare/deodorant-balm.webp"],
      tags: ["Deodorant", "Balm", "Premium"],
      shortDescription: "Maklon Deodorant Balm format stick padat yang praktis — tidak berantakan, cocok untuk on-the-go, dan memberikan perlindungan anti-bau sepanjang hari.",
      story: `Ingin punya brand deodorant balm stick sendiri? Dreamlab adalah solusi Anda untuk mengembangkan deodorant balm dengan format stick padat yang praktis — tidak tumpah, tidak berantakan, dan mudah dibawa kemana saja.\n\nDreamlab memformulasikan deodorant balm dengan bahan alami seperti shea butter dan vitamin E yang melembapkan sekaligus melindungi dari bau badan. Teksturnya yang padat meleleh lembut saat digosokkan ke kulit, memberikan sensasi nyaman tanpa lengket. Cocok untuk gaya hidup aktif dan traveling.`,
      seoParagraph: "Maklon Deodorant Balm — jasa maklon deodorant balm stick padat BPOM & Halal, praktis anti-bau seharian, tidak berantakan. Formula eksklusif, konsultasi gratis Dreamlab.",
      benefits: [
        "FREE Custom Formula — Anda menentukan bahan aktif dan aroma deodorant balm.",
        "FREE Pengurusan Legalitas — BPOM, HKI, dan Halal diurus sampai tuntas oleh tim kami.",
        "FREE Desain Logo & Kemasan — dibantu tim kreatif Dreamlab.",
        "1 Client, 1 Formula — formula eksklusif milik brand Anda, tidak dipakai brand lain.",
        "Format Stick Padat — praktis, tidak tumpah, cocok travel",
        "Shea Butter + Vitamin E — melembapkan & menutrisi kulit ketiak",
        "Sertifikasi BPOM & Halal",
      ],
      ingredients: [
        { name: "Natural Deo Actives", origin: "Germany", function: "Bahan aktif anti-bau alami" },
        { name: "Shea Butter", origin: "Africa", function: "Melembapkan dan menutrisi kulit" },
        { name: "Vitamin E", origin: "Germany", function: "Antioksidan dan perawatan kulit" },
      ],
      sizeOptions: ["30g", "50g", "75g"],
      bottleOptions: ["Stick Tube", "Custom"],
      capOptions: ["Twist-up Cap", "Screw Cap"],
      moq: "1000 pcs",
      productionTime: "2-3 bulan",
      certifications: ["BPOM", "Halal MUI", "CPKB Grade A"],
    },
...
Neck Cream Dreamlab diformulasikan khusus untuk kulit leher yang lebih tipis dan rentan terhadap garis halus serta kekenduran. Dengan Peptide Complex untuk merangsang produksi kolagen, Hyaluronic Acid untuk hidrasi mendalam, dan bahan pengencang alami. Penggunaan rutin membantu mengencangkan kulit leher, menyamarkan garis halus, dan menjaga elastisitas untuk tampilan yang lebih muda.`,
  ...
  relatedProducts: [
    ...
    { name: "Deodorant Balm", slug: "deodorant-balm", image: "/new asset/bodycare/deodorant-balm.webp", category: "Body Care", categorySlug: "bodycare" },
  ],
};