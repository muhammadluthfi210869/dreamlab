          ...
          <div className="max-w-xl md:max-w-2xl lg:max-w-3xl text-left space-y-6 md:space-y-8">
            ...
            <div className="hero-fade-in" style={{ animationDelay: "0.65s" }}>
              <div className="flex flex-wrap items-center gap-4">
                <a
                  href="/ads/thankyou/google-ads/?source=google-haircare&from=/google-ads/maklon-hair-care/"
      ...
      <section className="bg-white py-16 md:py-24 border-t border-neutral-100">
        <div className="container-custom px-4">
          ...
          <div className="text-center mt-12 md:mt-16">
            <a href="/ads/thankyou/google-ads/?source=google-haircare&from=/google-ads/maklon-hair-care/" className="inline-flex items-center gap-2 px-10 py-5 bg-brand-orange hover:bg-[#D98200] text-white rounded-full font-bold uppercase tracking-widest text-xs md:text-sm hover:-translate-y-1 transition-all duration-300 shadow-lg shadow-brand-orange/25">
