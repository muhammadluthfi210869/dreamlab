...
export const metadata: Metadata = {
  title: "Our Clients | 500+ Brands Trust Dreamlab Production",
  description:
    "Discover the cosmetics & skincare brands that partner with Dreamlab. 500+ brands trust our certified contract manufacturing for their products.",
  alternates: buildAlternates("/en/our-client/"),
  openGraph: {
    title: "Our Clients | 500+ Brands Trust Dreamlab Production",
    description:
      "See the cosmetic & skincare brands already working with Dreamlab, and become our next partner.",
  ...
  return (
    <main className="min-h-screen bg-brand-white pt-28 md:pt-36">
      <section className="px-6 lg:px-8 py-12 md:py-16 text-center max-w-4xl mx-auto">
        <p className="text-[11px] font-black uppercase tracking-[0.35em] text-[#b06f00]">Our Clients</p>
        <h1 className="mt-4 text-4xl md:text-5xl font-black tracking-tight text-[#1f1f1d]">
          500+ Brands Trust Dreamlab
        </h1>
        <p className="mt-5 text-base md:text-lg text-neutral-600 leading-relaxed max-w-2xl mx-auto">
          From emerging startups to established names, cosmetic brands across Indonesia choose
          Dreamlab as their primary contract manufacturing partner.
        </p>
      </section>
      ...
      <section className="px-6 lg:px-8 pb-12 max-w-5xl mx-auto">
        <div className="rounded-[32px] border border-[#eadfcf] bg-white p-8 md:p-12">
          ...
          <p className="mt-8 text-center text-sm text-neutral-500">
            … and 500+ more brands that trust Dreamlab&apos;s certified production.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 lg:px-8 pb-16">
        <div className="mx-auto max-w-5xl rounded-[32px] bg-brand-orange p-8 md:p-12 text-center">
          ...
          <p className="mt-4 mx-auto max-w-2xl text-sm md:text-base text-white/90">
            Join 500+ brands that trust Dreamlab&apos;s certified cosmetic manufacturing.
          </p>
          <div className="mt-6">
            <a
