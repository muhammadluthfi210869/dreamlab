...
export const metadata: Metadata = {
  title: "Contact Dreamlab | Cosmetic Manufacturing Surabaya, Indonesia",
  description:
    "Contact Dreamlab for a free consultation on your cosmetic or skincare brand. Certified BPOM & Halal contract manufacturing in Surabaya, East Java, Indonesia.",
  alternates: buildAlternates("/en/contact-us/"),
  openGraph: {
    title: "Contact Dreamlab | Cosmetic Manufacturing Surabaya, Indonesia",
    description:
      "Free consultation. Start your cosmetic & skincare brand with Dreamlab's certified contract manufacturing in East Java, Indonesia.",
  ...
  return (
    <main className="min-h-screen bg-[#FAF9F6] pt-28 md:pt-36">
      ...
      <section className="px-6 lg:px-8 py-12 md:py-16 text-center max-w-4xl mx-auto">
        <p className="text-[11px] font-black uppercase tracking-[0.35em] text-[#b06f00]">Contact Us</p>
        <h1 className="mt-4 text-4xl md:text-5xl font-black tracking-tight text-[#1f1f1d]">
          Let&apos;s Build Your Cosmetic Brand
        </h1>
