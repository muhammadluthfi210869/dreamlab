      ...
      <main className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="max-w-lg w-full mx-auto text-center space-y-8">
          ...
          <div className="space-y-4 pt-4">
            ...
            <button onClick={processWA} disabled={loading} className={`btn-wa inline-flex items-center justify-center gap-3 px-8 py-4 sm:px-10 sm:py-5 rounded-[50px] font-extrabold text-sm sm:text-base uppercase tracking-wider transition-all duration-300 shadow-lg hover:scale-[1.03] active:scale-95 w-full sm:w-auto mx-auto ${loading ? "opacity-70" : ""}`}>
